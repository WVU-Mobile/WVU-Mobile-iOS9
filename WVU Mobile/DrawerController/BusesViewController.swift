...
class BusesViewController: CenterViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = routes[indexPath.row].semesters
    ...
    // Footer - Add links for website and phone number.
    ...
    // Load Bus Line view after cell selection.
